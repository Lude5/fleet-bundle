...
SITE_CONFIG = {
    'name': os.environ.get('SITE_NAME', 'Volume Studio'),
    'name_part1': os.environ.get('SITE_NAME_PART1', 'Volume'),
    'name_part2': os.environ.get('SITE_NAME_PART2', 'Studio'),
    'domain': os.environ.get('SITE_DOMAIN', 'volumestudio.com'),
    'agent_name': os.environ.get('AGENT_NAME', 'KakoBuy'),
    'agent_domain': os.environ.get('AGENT_DOMAIN', 'kakobuy.com'),
    'agent_signup_url': os.environ.get('AGENT_SIGNUP_URL', 'https://www.kakobuy.com/register?affcode=volume'),
    'agent_product_url': os.environ.get('AGENT_PRODUCT_URL', 'https://www.kakobuy.com/item/details'),
    'affiliate_code': os.environ.get('AFFILIATE_CODE', 'volume'),
    'brand_color': os.environ.get('BRAND_COLOR', '#dc2626'),
    'brand_color_shadow': os.environ.get('BRAND_COLOR_SHADOW', '#991b1b'),
    'issue_number': os.environ.get('ISSUE_NUMBER', '01'),
    'hero_tagline': os.environ.get('HERO_TAGLINE', 'The Catalogue'),
    'hero_sub_tagline': os.environ.get('HERO_SUB_TAGLINE', 'Volume One'),
...
DATA_DIR = os.environ.get('VOLUME_DATA_DIR') or ('/data' if os.path.exists('/data') else os.path.join(os.path.dirname(__file__), 'data'))
