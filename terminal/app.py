...
SITE_CONFIG = {
    'name': os.environ.get('SITE_NAME', 'Terminal Finds'),
    'name_part1': os.environ.get('SITE_NAME_PART1', 'Terminal'),
    'name_part2': os.environ.get('SITE_NAME_PART2', 'Finds'),
    'domain': os.environ.get('SITE_DOMAIN', 'terminalfinds.com'),
    'agent_name': os.environ.get('AGENT_NAME', 'KakoBuy'),
    'agent_domain': os.environ.get('AGENT_DOMAIN', 'kakobuy.com'),
    'agent_signup_url': os.environ.get('AGENT_SIGNUP_URL', 'https://www.kakobuy.com/register?affcode=terminal'),
    'agent_product_url': os.environ.get('AGENT_PRODUCT_URL', 'https://www.kakobuy.com/item/details'),
    'affiliate_code': os.environ.get('AFFILIATE_CODE', 'terminal'),
    'brand_color': os.environ.get('BRAND_COLOR', '#22c55e'),
    'brand_color_shadow': os.environ.get('BRAND_COLOR_SHADOW', '#15803d'),
    'shell_prompt': os.environ.get('SHELL_PROMPT', 'guest@finds'),
    'system_name': os.environ.get('SYSTEM_NAME', 'FINDS_OS'),
    'system_version': os.environ.get('SYSTEM_VERSION', 'v1.0.0'),
    'meta_pixel_id': os.environ.get('META_PIXEL_ID', ''),
    'coupon_amount': os.environ.get('COUPON_AMOUNT', '400'),
    'tagline': os.environ.get('TAGLINE', 'The best finds. Lowest prices. Daily drops.'),
...
DATA_DIR = os.environ.get('TERMINAL_DATA_DIR') or ('/data' if os.path.exists('/data') else os.path.join(os.path.dirname(__file__), 'data'))
