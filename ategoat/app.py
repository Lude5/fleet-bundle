...
AGENTS = [
    ...
    {'key': 'lovegobuy',   'name': 'Lovegobuy',   'build': _b_lovegobuy,   'color': '#f59e0b', 'domain': 'lovegobuy.com',   'code': '2NPFDY',                                     'signup': 'https://www.lovegobuy.com/?invite_code={code}',     'coupon': 'Up to $150 in coupons'},
