...
SITE_CONFIG = {
    # ---- Brand ----
    'name':              os.environ.get('SITE_NAME', 'Minimal Studio'),
    'name_part1':        os.environ.get('SITE_NAME_PART1', 'Minimal'),
    'name_part2':        os.environ.get('SITE_NAME_PART2', 'Studio'),
    'domain':            os.environ.get('SITE_DOMAIN', 'minimalstudio.com'),
    'tagline':           os.environ.get('TAGLINE', 'Curated finds. Black on white. Nothing extra.'),
    ...
    'agent_signup_url':  os.environ.get('AGENT_SIGNUP_URL', 'https://www.kakobuy.com/register?affcode=minimal'),
    'agent_product_url': os.environ.get('AGENT_PRODUCT_URL', 'https://www.kakobuy.com/item/details'),
    'affiliate_code':    os.environ.get('AFFILIATE_CODE', 'minimal'),
    'coupon_amount':     os.environ.get('COUPON_AMOUNT', '400'),

    # ---- Colors (CSS variables — preview-mode.js can override these live) ----
    'brand_color':        os.environ.get('BRAND_COLOR', '#0a0a0a'),         # --accent
    'brand_color_shadow': os.environ.get('BRAND_COLOR_SHADOW', '#000000'),  # legacy hover
    'bg_color':           os.environ.get('BG_COLOR', '#ffffff'),            # --bg
    'text_color':         os.environ.get('TEXT_COLOR', '#0a0a0a'),          # --text
    'text_secondary':     os.environ.get('TEXT_SECONDARY', '#525252'),      # --text-secondary
    'text_muted':         os.environ.get('TEXT_MUTED', '#a3a3a3'),          # --text-muted
    'surface_color':      os.environ.get('SURFACE_COLOR', '#fafafa'),       # --surface
    'border_color':       os.environ.get('BORDER_COLOR', '#ededed'),        # --border-subtle

    # ---- Hero copy ----
    'hero_eyebrow':      os.environ.get('HERO_EYEBROW', ''),                # custom eyebrow; empty = auto from name+count
    'hero_headline':     os.environ.get('HERO_HEADLINE', 'Less,<br>better.'),
    ...
    'index_strip_words': os.environ.get(
        'INDEX_STRIP_WORDS',
        'Curated · {agent} · Weidian / Taobao / 1688 · Lowest shipping · Black on white · Nothing extra'
    ),
    ...
    # ---- Footer ----
    'footer_desc':       os.environ.get('FOOTER_DESC', 'Curated {agent} finds. Black on white. Nothing extra.'),
    'footer_tagline':    os.environ.get('FOOTER_TAGLINE', 'Curated with intent'),
...
DATA_DIR = os.environ.get('MINIMAL_DATA_DIR') or ('/data' if os.path.exists('/data') else os.path.join(os.path.dirname(__file__), 'data'))
