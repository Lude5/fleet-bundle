...
SITE_CONFIG = {
    'name': os.environ.get('SITE_NAME', 'Maywood Sheets'),
    'name_part1': os.environ.get('SITE_NAME_PART1', 'Maywood'),
    'name_part2': os.environ.get('SITE_NAME_PART2', 'Sheets'),
    'domain': os.environ.get('SITE_DOMAIN', 'maywoodsheets.com'),
    'agent_name': os.environ.get('AGENT_NAME', 'KakoBuy'),
    'agent_domain': os.environ.get('AGENT_DOMAIN', 'kakobuy.com'),
    'agent_signup_url': os.environ.get('AGENT_SIGNUP_URL', 'https://www.kakobuy.com/register?affcode=maywood'),
    'agent_product_url': os.environ.get('AGENT_PRODUCT_URL', 'https://www.kakobuy.com/item/details'),
    'affiliate_code': os.environ.get('AFFILIATE_CODE', 'maywood'),
...
DATA_DIR = os.environ.get('MAYWOOD_DATA_DIR') or ('/data' if os.path.exists('/data') else os.path.join(os.path.dirname(__file__), 'data'))
