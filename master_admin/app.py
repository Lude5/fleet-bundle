...
TEMPLATES_REGISTRY = [
    ...
    },
    {
        ...
        'status': 'coming-soon',
        'description': 'Magazine-style layout with Playfair Display serif headlines, generous whitespace, hero stories. For brands selling curation and taste over volume.',
        'color': '#f59e0b',
        'theme': 'Dark · editorial',
        'fonts': 'Playfair Display · Inter',
        'features': ['Story-style product pages', 'Vertical scroll narrative', 'Big serif typography', 'Volume-numbered drops', 'Editorial popups'],
        'preview_url': '',
        'folder': '',
    },
    {
        ...
        'status': 'coming-soon',
        'description': 'Light theme, monochrome, almost no color. For the "fashion editorial" audience that finds dark themes too gamer-y. Inspired by doppel.fit + theqcbook.com.',
        'color': '#171717',
        'theme': 'Light · minimal',
        'fonts': 'Instrument Sans · Inter',
        'features': ['White bg + black accents', 'Grid product layout', 'Quality-tier badges', 'Multi-agent switcher', 'Mobile bottom bar'],
        'preview_url': '',
        'folder': '',
    },
    {
