...
(function () {
    ...
    var THEMES = {
        ...
        light: {  // editorial natural — warm ivory paper
            '--bg':            '#faf6ef',
            '--bg-2':          '#f4efe5',
            '--paper':         '#ffffff',
            '--surface':       '#ffffff',
            ...
            '--text-muted':    '#8a8a8a',
            '--rule':          '#1a1a1a',
            '--rule-soft':     'rgba(24,24,26,0.12)',
            '--rule-faint':    'rgba(24,24,26,0.06)',
            '--border-subtle': 'rgba(24,24,26,0.08)',
            navBg:             '#faf6ef',
            mobileMenuBg:      '#faf6ef',
            heroOverlayR:      '250,246,239',
            heroOverlayMid:    '0.7',
            heroOverlayEdge:   '1',
            heroTextShadow:    'none',
            heroSubShadow:     'none',
