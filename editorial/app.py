...
SITE_CONFIG = {
    'name': os.environ.get('SITE_NAME', 'Editorial House'),
    'name_part1': os.environ.get('SITE_NAME_PART1', 'Editorial'),
    'name_part2': os.environ.get('SITE_NAME_PART2', 'House'),
    'domain': os.environ.get('SITE_DOMAIN', 'editorialhouse.com'),
    'agent_name': os.environ.get('AGENT_NAME', 'KakoBuy'),
    'agent_domain': os.environ.get('AGENT_DOMAIN', 'kakobuy.com'),
    'agent_signup_url': os.environ.get('AGENT_SIGNUP_URL', 'https://www.kakobuy.com/register?affcode=editorial'),
    'agent_product_url': os.environ.get('AGENT_PRODUCT_URL', 'https://www.kakobuy.com/item/details'),
    'affiliate_code': os.environ.get('AFFILIATE_CODE', 'editorial'),
    'brand_color': os.environ.get('BRAND_COLOR', '#8a1c1c'),
    'brand_color_shadow': os.environ.get('BRAND_COLOR_SHADOW', '#5a0f0f'),
    'meta_pixel_id': os.environ.get('META_PIXEL_ID', ''),
    'coupon_amount': os.environ.get('COUPON_AMOUNT', '400'),
    'tagline': os.environ.get('TAGLINE', 'A curated study in modern dress.'),
    'product_count_label': os.environ.get('PRODUCT_COUNT_LABEL', '100+'),
    'discord_url': os.environ.get('DISCORD_URL', ''),
    # Editorial-specific
    'issue_label': os.environ.get('ISSUE_LABEL', 'No. 01'),
    'issue_season': os.environ.get('ISSUE_SEASON', 'Spring / Summer 2026'),
    'hero_kicker': os.environ.get('HERO_KICKER', 'The Edit'),
    'hero_title': os.environ.get('HERO_TITLE', 'Modern Dress'),
    'hero_title_italic': os.environ.get('HERO_TITLE_ITALIC', 'reconsidered'),
    'hero_byline': os.environ.get('HERO_BYLINE', 'Curated by the house. Updated continuously. Lowest shipping rates guaranteed.'),
    'editor_name': os.environ.get('EDITOR_NAME', 'The Editor'),
}

ADMIN_PASSWORD = os.environ.get('ADMIN_PASSWORD', 'changeme123')
ADMIN_API_TOKEN = os.environ.get('ADMIN_API_TOKEN', '')  # for cross-site master-admin calls
DATA_DIR = os.environ.get('EDITORIAL_DATA_DIR') or ('/data' if os.path.exists('/data') else os.path.join(os.path.dirname(__file__), 'data'))
