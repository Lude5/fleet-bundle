...
SITE_CONFIG = {
    'name': os.environ.get('SITE_NAME', 'Kai Finds'),
    'name_part1': os.environ.get('SITE_NAME_PART1', 'Kai'),
    'name_part2': os.environ.get('SITE_NAME_PART2', 'Finds'),
    'domain': os.environ.get('SITE_DOMAIN', 'kaifinds.com'),
    'agent_name': os.environ.get('AGENT_NAME', 'KakoBuy'),
    'agent_domain': os.environ.get('AGENT_DOMAIN', 'kakobuy.com'),
    'agent_signup_url': os.environ.get('AGENT_SIGNUP_URL', 'https://www.kakobuy.com/register?affcode=kai'),
    'agent_product_url': os.environ.get('AGENT_PRODUCT_URL', 'https://www.kakobuy.com/item/details'),
    'affiliate_code': os.environ.get('AFFILIATE_CODE', 'kai'),
    'brand_color': os.environ.get('BRAND_COLOR', '#06b6d4'),
    'brand_color_shadow': os.environ.get('BRAND_COLOR_SHADOW', '#0891b2'),
...
DATA_DIR = os.environ.get('KAI_DATA_DIR') or ('/data' if os.path.exists('/data') else os.path.join(os.path.dirname(__file__), 'data'))
